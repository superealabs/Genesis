...
public class Constantes {
    ...
    public static final String PROJECT_CONFIGURATION_YAML = "data_genesis/yaml/projectsfiles/";
    ...
    // FRAMEWORKS
    public static final int REST_API_ID = 1;
    public static final int Eureka_Server_ID = 3;
    public static final int Api_Gateway_ID = 4;
    public static final int MVC_Framework_ID = 5;
    public static final int NET_ID = 2;

    // SPRING FRAMEWORKS
    public static final int REST_API = 1;
    public static final int Eureka_Server = 2;
    public static final int Api_Gateway = 3;
    public static final int MVC_Framework = 4;
