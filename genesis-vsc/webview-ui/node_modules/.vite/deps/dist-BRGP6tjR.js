...
var plugin = /*@__PURE__*/ ViewPlugin.fromClass(class {
	...
	update(update) {
		let { view } = update;
		let height = view.viewState.editorHeight - view.defaultLineHeight - view.documentPadding.top - .5;
...
*/
var showTooltip = /*@__PURE__*/ Facet.define({ enables: [tooltipPlugin, baseTheme] });
...
//#endregion
export { StyleModule as $, highlightActiveLine as A, lineNumbers as B, getPanel as C, gutterWidgetClass as D, gutterLineClass as E, hoverTooltip as F, repositionTooltips as G, panels as H, keymap as I, showDialog as J, runScopeHandlers as K, layer as L, highlightSpecialChars as M, highlightTrailingWhitespace as N, gutters as O, highlightWhitespace as P, crelt as Q, lineNumberMarkers as R, getDrawSelectionConfig as S, fromCodePoint as St, gutter as T, placeholder as U, logException as V, rectangularSelection as W, showTooltip as X, showPanel as Y, tooltips as Z, closeHoverTooltips as _, codePointAt as _t, Decoration as a, EditorSelection as at, dropCursor as b, countColumn as bt, GutterMarker as c, MapMode as ct, ViewPlugin as d, RangeSetBuilder as dt, Annotation as et, ViewUpdate as f, RangeValue as ft, closeHoverTooltip as g, Transaction as gt, activateHover as h, Text as ht, BlockWrapper as i, Compartment as it, highlightActiveLineGutter as j, hasHoverTooltips as k, MatchDecorator as l, Prec as lt, __test as m, StateField as mt, BlockInfo as n, ChangeSet as nt, Direction as o, EditorState as ot, WidgetType as p, StateEffect as pt, scrollPastEnd as q, BlockType as r, CharCategory as rt, EditorView as s, Facet as st, BidiSpan as t, ChangeDesc as tt, RectangleMarker as u, RangeSet as ut, crosshairCursor as v, codePointSize as vt, getTooltip as w, getDialog as x, findClusterBreak as xt, drawSelection as y, combineConfig as yt, lineNumberWidgetMarker as z };
