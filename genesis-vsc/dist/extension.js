...
class GenesisApiService {
    ...
    async start(context) {
        try {
            ...
            this.process = (0, child_process_1.spawn)('java', [
                '-jar', jarPath,
            ...
            (0, genesisAxiosInstance_1.createAxiosInstance)(this.port);
            this.ready = true;
        }
        catch (err) {
    ...
    async generateJavaFile(className, destinationPath) {
        if (!this.port) {
            return { success: 'false', message: 'Genesis API non démarrée' };
        }
        const response = await fetch(`http://127.0.0.1:${this.port}/api/generator/java?className=${className}&destinationPath=${encodeURIComponent(destinationPath)}`, { method: 'POST' });
    ...
    waitForApi(retries = 20) {
        return new Promise((resolve, reject) => {
            let attempts = 0;
            const check = () => {
                if (!this.port)
                    return reject(new Error('Port non défini'));
...
exports.GenesisApiService = GenesisApiService;
...
let instance = null;
function createAxiosInstance(port) {
...
function getAxiosInstance() {
    if (!instance)
        throw new Error('[Genesis] axiosInstance non initialisée. Le JAR est-il démarré ?');
    return instance;
}
...
var FormData$1 = __webpack_require__(7);
var crypto = __webpack_require__(16);
var url = __webpack_require__(14);
var HttpsProxyAgent = __webpack_require__(67);
var http = __webpack_require__(12);
var https = __webpack_require__(13);
var http2 = __webpack_require__(85);
var util = __webpack_require__(9);
var path = __webpack_require__(3);
var followRedirects = __webpack_require__(86);
...
var CombinedStream = __webpack_require__(8);
var util = __webpack_require__(9);
var path = __webpack_require__(3);
var http = __webpack_require__(12);
var https = __webpack_require__(13);
...
var asynckit = __webpack_require__(20);
var setToStringTag = __webpack_require__(30);
var hasOwn = __webpack_require__(64);
var populate = __webpack_require__(66);
...
var util = __webpack_require__(9);
var Stream = (__webpack_require__(10).Stream);
var DelayedStream = __webpack_require__(11);
...
module.exports =
{
  parallel      : __webpack_require__(21),
  serial        : __webpack_require__(28),
  serialOrdered : __webpack_require__(29)
};
...
var iterate    = __webpack_require__(22)
  , initState  = __webpack_require__(26)
  , terminator = __webpack_require__(27)
  ;
...
var defer = __webpack_require__(24);
...
var serialOrdered = __webpack_require__(29);
...
var hasToStringTag = __webpack_require__(65)();
var hasOwn = __webpack_require__(64);
var $TypeError = __webpack_require__(38);
...
var $Object = __webpack_require__(32);

var $Error = __webpack_require__(33);
var $EvalError = __webpack_require__(34);
var $RangeError = __webpack_require__(35);
var $ReferenceError = __webpack_require__(36);
var $SyntaxError = __webpack_require__(37);
var $TypeError = __webpack_require__(38);
var $URIError = __webpack_require__(39);

var abs = __webpack_require__(40);
var floor = __webpack_require__(41);
var max = __webpack_require__(42);
var min = __webpack_require__(43);
var pow = __webpack_require__(44);
var round = __webpack_require__(45);
...
var $ReflectGPO = __webpack_require__(54);
...
var $isNaN = __webpack_require__(47);
...
var reflectGetProto = __webpack_require__(54);
var originalGetProto = __webpack_require__(55);

var getDunderProto = __webpack_require__(56);
...
var callBind = __webpack_require__(57);
var gOPD = __webpack_require__(48);
...
var $call = __webpack_require__(60);
var $actualApply = __webpack_require__(61);
...
var $apply = __webpack_require__(62);
var $call = __webpack_require__(60);
var $reflectApply = __webpack_require__(63);
...
const agent_1 = __importDefault(__webpack_require__(68));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const net_1 = __importDefault(__webpack_require__(2));
const tls_1 = __importDefault(__webpack_require__(69));
const url_1 = __importDefault(__webpack_require__(14));
const assert_1 = __importDefault(__webpack_require__(70));
const debug_1 = __importDefault(__webpack_require__(71));
const agent_base_1 = __webpack_require__(81);
const parse_proxy_response_1 = __importDefault(__webpack_require__(84));
...
try {
	...
	const supportsColor = __webpack_require__(77);
...
/* harmony export */ });
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78);
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(79);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(80);
...
const events_1 = __webpack_require__(82);
const debug_1 = __importDefault(__webpack_require__(71));
const promisify_1 = __importDefault(__webpack_require__(83));
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(71)("follow-redirects");
    }
    catch (error) { /* */ }
...
const vscode = __importStar(__webpack_require__(90));
const GenesisPanel_1 = __webpack_require__(91);
function registerCommands(context, genesisApi) {
    context.subscriptions.push(vscode.commands.registerCommand('genesis.helloWorld', () => {
        GenesisPanel_1.GenesisPanel.show(context, genesisApi);
    }));
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GenesisPanel = void 0;
const vscode = __importStar(__webpack_require__(90));
const fs = __importStar(__webpack_require__(15));
const path = __importStar(__webpack_require__(3));
const WebviewMessageRouter_1 = __webpack_require__(92);
class GenesisPanel {
    context;
    genesisApi;
    static instance;
    ...
    messageRouter;
    constructor(panel, context, genesisApi) {
        this.context = context;
        this.genesisApi = genesisApi;
        this.panel = panel;
        // 1. Initialisation du routeur de messages
        this.messageRouter = new WebviewMessageRouter_1.WebviewMessageRouter(this.panel, this.genesisApi, this.context);
    ...
    static show(context, genesisApi) {
        if (GenesisPanel.instance) {
            GenesisPanel.instance.cancelShutdown();
            GenesisPanel.instance.panel.reveal();
            return;
        }
        const panel = vscode.window.createWebviewPanel('genesisWebview', 'Genesis', vscode.ViewColumn.Active, {
            enableScripts: true,
    ...
    getThemeConfig() {
        ...
        return {
            theme: config.get('theme', 'genesis'),
            colorMode: config.get('colorMode', 'auto')
        };
    }
    watchConfiguration() {
...
exports.GenesisPanel = GenesisPanel;
...
const vscode = __importStar(__webpack_require__(90));
const FrameworkHandler_1 = __webpack_require__(93);
const GeneratorHandler_1 = __webpack_require__(94);
const FrontendFrameworkHandler_1 = __webpack_require__(95);
class WebviewMessageRouter {
    ...
    generatorHandler;
    frontendHandler;
    constructor(panel, genesisApi, context) {
        this.panel = panel;
        this.genesisApi = genesisApi;
        this.context = context;
        // Initialisation des handlers (adapte les constructeurs si nécessaire)
        this.frameworkHandler = new FrameworkHandler_1.FrameworkHandler();
        this.generatorHandler = new GeneratorHandler_1.GeneratorHandler(this.panel);
        this.frontendHandler = new FrontendFrameworkHandler_1.FrontendHandler(this.panel);
    }
    /**
...
class FrameworkHandler {
    async getAll(_payload, panel) {
        try {
            const { data } = await (0, genesisAxiosInstance_1.getAxiosInstance)().get('/frameworks');
            panel.webview.postMessage({ type: 'FRAMEWORKS_LOADED', payload: data });
        }
        catch (error) {
            console.warn('[FrameworkHandler] API échouée, utilisation du fallback statique:', error.message);
            panel.webview.postMessage({ type: 'FRAMEWORKS_LOADED', payload: MOCK_FRAMEWORKS });
        }
    }
    async select(payload, panel) {
        try {
            const { data } = await (0, genesisAxiosInstance_1.getAxiosInstance)().post(`/frameworks/${payload.id}/select`);
...
class GeneratorHandler {
    ...
    async handleRequestFilePath(extensions) {
    ...
    async handleGetTablesMetadata(_payload, panel) {
        try {
            const { data } = await (0, genesisAxiosInstance_1.getAxiosInstance)().get('/tables_metadata_loaded');
            panel.webview.postMessage({ type: 'TABLES_METADATA_LOADED', payload: data });
        }
        catch (error) {
            console.warn('[GeneratorHandler] API échouée, utilisation du fallback statique:', error.message);
            this.panel.webview.postMessage({
    ...
    async handleGetTablesMetadataParents(_payload, panel) {
        try {
            const { data } = await (0, genesisAxiosInstance_1.getAxiosInstance)().get('/tables_metadata/parents');
            panel.webview.postMessage({ type: 'TABLES_METADATA_PARENTS_LOADED', payload: data });
        }
        catch (error) {
            console.warn('[GeneratorHandler] API Parents échouée, utilisation du fallback statique:', error.message);
            panel.webview.postMessage({
    ...
    async handleGetTablesMetadataChilds(_payload, panel) {
        try {
            const { data } = await (0, genesisAxiosInstance_1.getAxiosInstance)().get('/tables_metadata/childs');
            panel.webview.postMessage({ type: 'TABLES_METADATA_CHILDS_LOADED', payload: data });
        }
        catch (error) {
            console.warn('[GeneratorHandler] API Childs échouée, utilisation du fallback statique:', error.message);
            panel.webview.postMessage({
    ...
    async handleGetRelations(_payload, panel) {
        try {
            const { data } = await (0, genesisAxiosInstance_1.getAxiosInstance)().get('/relations');
            panel.webview.postMessage({ type: 'RELATIONS_LOADED', payload: data });
        }
        catch (error) {
            console.warn('[GeneratorHandler] API Relations échouée, utilisation du fallback statique:', error.message);
            panel.webview.postMessage({
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.FrontendHandler = void 0;
const genesisAxiosInstance_1 = __webpack_require__(5);
// ═══ DONNÉES STATIQUES (FALLBACK) ═══
const MOCK_FRONTEND_FRAMEWORKS = [
    {
        id: 1,
        languageId: 2,
        name: 'React',
...
class FrontendHandler {
    ...
    async handleGetFrontendFrameworks(_payload) {
        try {
            const { data } = await (0, genesisAxiosInstance_1.getAxiosInstance)().get('/frontend_frameworks');
            this.panel.webview.postMessage({
            ...
            console.warn('[FrontendHandler] API Frontend Frameworks échouée, utilisation du fallback statique:', error.message);
            this.panel.webview.postMessage({
                type: 'FRONTEND_FRAMEWORKS_LOADED',
    ...
    async handleGetAvailableLanguages(_payload) {
        try {
            // Tentative d'appel à l'API Java (à adapter selon ton endpoint réel)
            const { data } = await (0, genesisAxiosInstance_1.getAxiosInstance)().get('/frontend/languages');
            this.panel.webview.postMessage({
            ...
            console.warn('[FrontendHandler] API Languages échouée, utilisation du fallback statique:', error.message);
            this.panel.webview.postMessage({
                type: 'AVAILABLE_LANGUAGES_LOADED',
...
exports.FrontendHandler = FrontendHandler;
...
const GenesisApiService_1 = __webpack_require__(1);
const registerCommands_1 = __webpack_require__(89);
// On crée l'instance, mais on ne la démarre PAS encore
const genesisApi = new GenesisApiService_1.GenesisApiService();
async function activate(context) {
    // Enregistrer les commandes immédiatement
    (0, registerCommands_1.registerCommands)(context, genesisApi);
}
function deactivate() {
