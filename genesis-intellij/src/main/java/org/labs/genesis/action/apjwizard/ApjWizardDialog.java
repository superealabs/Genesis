    ...
    private void nextStep() throws ConfigurationException {
        ...
        if (currentStepIndex == 0) {
            WizardStep nextStep = switch (context.getApjfile().getId()) {
                ...
                case ConstantesApj.MAPPING_ID -> new PageRechercheGroupeWizardStep(context,project);
                case ConstantesApj.MAPPING_MERE_FILLE_ID -> new PageRechercheGroupeWizardStep(context,project);
                default -> null;
            };
